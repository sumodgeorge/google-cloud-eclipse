...
OAUTH_CLIENT_ID=$KOKORO_KEYSTORE_DIR/${KEYSTORE_CONFIG_ID}_CLIENT_ID
OAUTH_CLIENT_SECRET=$KOKORO_KEYSTORE_DIR/${KEYSTORE_CONFIG_ID}_CLIENT_SECRET
FIRELOG_API_KEY=$KOKORO_KEYSTORE_DIR/${KEYSTORE_CONFIG_ID}_FIRELOG_API_KEY
